...
RPD_OUTPUT_ROOT=${RPD_OUTPUT_ROOT:-outputs/rpd_official_runs/dapo_seed${SEED}_tree32_64_128_256_full025_10}
...
if [ ! -f "${MANIFEST}" ] || [ "${OVERWRITE_MANIFEST:-0}" = "1" ]; then
    printf "kind\tsetting\tjob_id\trun_name\tinput_dir\n" > "${MANIFEST}"
fi
