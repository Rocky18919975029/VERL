...
EXPORTS="ALL,PROJECT_NAME=${PROJECT_NAME},RUN_NAME=${RUN_NAME},HPF_TRANSITION_LAMBDA=${HPF_TRANSITION_LAMBDA},RESUME_MODE=${RESUME_MODE},EXPECTED_PROJECT_NAME=${EXPECTED_PROJECT_NAME},EXPECTED_RUN_NAME=${EXPECTED_RUN_NAME},EXPECTED_TRANSITION_LAMBDA=${EXPECTED_TRANSITION_LAMBDA},EXPECTED_RESUME_STEP=${EXPECTED_RESUME_STEP},TOTAL_TRAINING_STEPS=${TOTAL_TRAINING_STEPS}"
